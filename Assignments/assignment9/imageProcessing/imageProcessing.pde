...
void draw() {
  ...
  if (!done) {
    ...
    PImage blob_original = loadImage("BlobDetection_Test.png");
    PImage blob = loadImage("BlobDetection_Test.png");
    blob = blobs.findConnectedComponents(blob, false);
    image(blob_original, 0, 0);
    image(blob, blob.width, 0);
